...
--
-- Temporary view structure for view `pessoacargo`
--

DROP TABLE IF EXISTS `pessoacargo`;
/*!50001 DROP VIEW IF EXISTS `pessoacargo`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `pessoacargo` AS SELECT 
...
--
-- Temporary view structure for view `pessoaestatus`
--

DROP TABLE IF EXISTS `pessoaestatus`;
/*!50001 DROP VIEW IF EXISTS `pessoaestatus`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `pessoaestatus` AS SELECT 
 1 AS `nome_pessoa`,
 1 AS `nome_status`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `pessoacargo`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pessoacargo` AS select `funcionario`.`pessoa_cpf_pessoa` AS `pessoa_cpf_pessoa`,`pessoa`.`nome_pessoa` AS `nome_pessoa`,`cargo`.`nome_cargo` AS `nome_cargo` from ((`pessoa` join `funcionario`) join `cargo`) where ((`pessoa`.`cpf_pessoa` = `funcionario`.`pessoa_cpf_pessoa`) and (`cargo`.`id_cargo` = `funcionario`.`cargo_id_cargo`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `pessoaestatus`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `pessoaestatus` AS select `pessoa`.`nome_pessoa` AS `nome_pessoa`,`status`.`nome_status` AS `nome_status` from (`pessoa` join `status`) where (`status`.`id_status` = `pessoa`.`status_id_status`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-04-23  9:20:00
